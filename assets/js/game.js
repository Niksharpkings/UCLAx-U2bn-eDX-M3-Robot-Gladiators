...
const fight = (enemy) => {
  ...
  while (playerInfo.health > 0 && enemy.health > 0) {
    ...
    console.log(`%c${playerInfo.name} attacked${enemy.name}. ${enemy.name} now has ${enemy.health} health remaining.`, "color: yellow; font-style: italic; background-color: blue;padding: 2px");
    ...
    console.log(`%c${enemy.name} attacked ${playerInfo.name}. ${playerInfo.name} now has ${playerInfo.health} health remaining.`, "color: yellow; font-style: italic; background-color: blue;padding: 2px");
...
const startGame = function () {
  ...
  for (let i = 0; i < enemyInfo.length; i++) {
    ...
    if (playerInfo.health > 0) {
      ...
      // debugger;
      // pass the playerInfo.money variable's value into the fight function, where it will assume the value of the enemy.name parameter
...
//to guarantee entering the loop at least once to prompt the player for the player-robot name
  var name = "";
  //condition that checks if name is blank or null
